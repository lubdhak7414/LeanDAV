...
function file_type_icon_svg(string $ext): string {
    ...
    // File icon with subtle fill for better visibility
    return '<svg width="18" height="18" viewBox="0 0 24 24" fill="' . $color . '" fill-opacity="0.15" stroke="' . $color . '" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"></path><polyline points="13 2 13 9 20 9"></polyline></svg>';
}
