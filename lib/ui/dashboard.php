                        ...
                        <?php foreach ($entry_meta as $meta): ?>
                            ...
                            <div class="file-item"
                                ...
                                <div class="actions col-actions">
                                    <?php if (!$is_dir): ?>
                                        <button type="button" aria-label="Download <?php echo htmlspecialchars($entry); ?>" onclick="downloadFile('<?php echo htmlspecialchars(rawurlencode($entry_url)); ?>')" title="Download">
                                            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg>
                                        </button>
                                    <?php endif; ?>
                                    <?php if ($is_zip): ?>
                                        <button type="button" aria-label="Extract <?php echo htmlspecialchars($entry); ?>" onclick="unzipFile('<?php echo htmlspecialchars(rawurlencode($entry_url)); ?>', '<?php echo htmlspecialchars(addslashes($entry)); ?>')" title="Extract archive">
                                    ...
                                    <?php endif; ?>
                                    <button type="button" aria-label="Rename <?php echo htmlspecialchars($entry); ?>" onclick="showRenameModal(<?php echo json_encode($entry, JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP); ?>, '<?php echo htmlspecialchars(rawurlencode($entry_url)); ?>')" title="Rename">
                                    ...
                                    <button type="button" class="delete" aria-label="Delete <?php echo htmlspecialchars($entry); ?>" onclick="deleteItem('<?php echo htmlspecialchars(rawurlencode($entry_url)); ?>', <?php echo json_encode($entry, JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP); ?>)" title="Delete">
